...
function newNumber1 (maxNumber) {
   ...
   let x = Math.floor(Math.random() * maxNumber) + 1;
    ...
    if (x <= 15) {
        ...
        console.log(`Random number is ${x} is in "B"`);
        B = true;
        ...
        console.log(`Random number is ${x} is in "I"`);
        I = true;
        ...
        console.log(`Random number is ${x} is in "N"`);
        N = true;
        ...
        console.log(`Random number is ${x} is in "G"`);
        G = true;
        ...
        console.log(`Random number is ${x} is in "O"`);
        O = true;
        ...
        console.log(`Random number is ${x} is invalid.`);
    }
